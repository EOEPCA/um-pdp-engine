...
(Represented in the above graph by the request to Login Service called "Get Attributes for User")
...
(Represented in the above graph by the request to Back-end database called "Get the policies related to the resources ids")
